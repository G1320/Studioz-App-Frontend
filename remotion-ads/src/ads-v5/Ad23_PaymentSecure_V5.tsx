/**
 * Ad23 — Secure Payments
 * 240 frames (8s) at 30fps, 1080x1920 (9:16 portrait)
 * V5: Order form screenshot showing payment flow.
 */
...
/* ─── Scene 1: Secure Payment Features ─── */
const Scene1: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        <SectionLabel text="SECURITY" delay={0} />
        <h1
          style={{
        ...
        >
          <GoldText>תשלומים מאובטחים</GoldText>
        </h1>
        <p
          style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: s(16), marginTop: s(30) }}>
          ...
          <FeatureCard
            Icon={Lock}
            title="מידע מוגן"
            desc="פרטי לקוח מאובטחים"
            delay={26}
            accentColor={SUCCESS}
          />
          <FeatureCard
            Icon={CreditCard}
            title="מגוון אמצעי תשלום"
            desc="כרטיס, Bit, PayPal, Apple Pay"
            delay={34}
          />
        </div>
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        >
          חוויית <GoldText>תשלום חלקה</GoldText>
        </h2>
        <ScreenshotFrame
...
const Scene3: React.FC = () => (
  <CTAScene
    headline={
      <>
        תשלומים <GoldText>בלי דאגות</GoldText>
      </>
    }
  />
);
...
/* ─── Main Export ─── */
export const Ad23_PaymentSecure_V5: React.FC = () => (
  <AbsoluteFill>
