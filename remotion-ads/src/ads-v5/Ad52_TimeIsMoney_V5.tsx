/**
 * Ad52_TimeIsMoney_V5
 * Theme: Time is money — no fake amounts
    ...
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: s(14), marginTop: s(15) }}>
          <PainCard Icon={Phone} text="שעות על הטלפון עם לקוחות" delay={12} />
          <PainCard Icon={ClipboardList} text="ניהול ידני של הזמנות" delay={22} />
          <PainCard Icon={MessageSquare} text="מעקב בווטסאפ ואקסלים" delay={32} />
          <PainCard Icon={Clock} text="זמן שהיה יכול ללכת ליצירה" delay={42} />
        </div>
      </div>
    </AbsoluteFill>
  );
...
const SceneEfficiency: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        <SectionLabel text="EFFICIENCY" delay={0} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: s(14), marginTop: s(20) }}>
          ...
          <FeatureCard Icon={Calendar} title="ניהול יומן חכם" delay={33} />
          <FeatureCard Icon={CreditCard} title="תשלומים ומקדמות" delay={41} />
          <FeatureCard Icon={FileText} title="חשבוניות אוטומטיות" delay={49} />
        </div>
      </div>
    </AbsoluteFill>
  );
...
/* ─── Main Export ─── */
export const Ad52_TimeIsMoney_V5: React.FC = () => (
  <AbsoluteFill>
