...
export const Post1_CancellationPain_V4: React.FC = () => {
  return (
          ...
          {[
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                <span style={{ fontSize: 14, color: RED, fontWeight: 600, fontFamily: FONT_BODY }}>
                  ביטול
                </span>
                <span style={{ fontSize: 14, color: SUBTLE_TEXT, fontFamily: FONT_MONO }}>
                  {notif.time}
                </span>
              </div>
            </div>
