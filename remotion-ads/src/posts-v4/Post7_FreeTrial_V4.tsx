...
export const Post7_FreeTrial_V4: React.FC = () => {
  const benefits = [
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        >
          <span style={{ fontFamily: FONT_HEADING, fontSize: 27, fontWeight: 700, color: DARK_BG }}>
            הצטרף עכשיו — בחינם
          </span>
        ...
        <div style={{ display: "flex", gap: 18, justifyContent: "center", paddingTop: 14, paddingBottom: 6 }}>
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{ fontFamily: FONT_BODY, fontSize: 13, color: SUBTLE_TEXT }}>
                {badge.text}
              </span>
            </div>
          ))}
