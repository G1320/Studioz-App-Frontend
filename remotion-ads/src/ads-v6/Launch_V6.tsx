/**
 * Launch_V6 — Cinematic product launch video for FB/IG (DARK MODE)
 * 1350 frames (45s) at 30fps, 1080×1920
 *
 * Structure:
 *   1. Cold Open — dramatic text reveal (0–100)
 *   2. Brand Reveal — logo + name with particle-like glow (90–210)
 *   3. Problem Montage — rapid-fire pain points (200–340)
 *   4. Transition Wipe — "יש דרך טובה יותר" (330–400)
 *   5. Product Showcase — triple phone spread with parallax (390–570)
 *   6. Feature Deep-Dives — 4 mini cards cycling (560–760)
 *   7. Dashboard Demo — analytics phone + floating stats (750–900)
 *   8. Social Proof — counter animations (890–1010)
 *   9. Pricing Reveal — "₪0" cinematic drop (1000–1110)
 *  10. Final CTA — full branded close (1100–1350)
 */
...
/*  Dramatic text reveal with staggered lines                      */
/* ═══════════════════════════════════════════════════════════════ */
...
/*  Logo scales up with radial glow burst                          */
/* ═══════════════════════════════════════════════════════════════ */
const SceneBrandReveal: React.FC = () => {
  ...
  const glowPulse = interpolate(Math.sin(frame * 0.05), [-1, 1], [0.6, 1]);
      ...
      <SafeZone style={{ alignItems: "center", justifyContent: "center", gap: s(20) }}>
        <Img
          ...
          style={{
            ...
            height: s(130),
            borderRadius: s(30),
            boxShadow: `0 ${s(12)}px ${s(50)}px rgba(0,0,0,0.5), 0 0 ${s(60)}px ${COLORS.accent}15`,
...
/*  Rapid-fire pain points that get struck through                 */
/* ═══════════════════════════════════════════════════════════════ */
  ...
  return (
    <AbsoluteFill style={{ ...RTL }}>
      ...
      <SafeZone style={{ alignItems: "center", justifyContent: "center" }}>
        ...
        >
          <Zap size={s(48)} color={COLORS.accent} strokeWidth={1.5} style={{ filter: `drop-shadow(0 0 ${s(20)}px ${COLORS.accent}40)`, opacity: glow } as any} />
          <h2
            style={{
              fontFamily: FONT,
              fontSize: s(52),
...
/* ═══════════════════════════════════════════════════════════════ */
/*  Scene 5: Product Showcase — Triple Phone Spread (390–570)      */
/*  Three phones fan out with different screens                    */
/* ═══════════════════════════════════════════════════════════════ */
...
/*  Glass cards with icons cycling in                              */
/* ═══════════════════════════════════════════════════════════════ */
...
/*  Phone mockup + floating stat cards                             */
/* ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════ */
/*  Scene 8: Social Proof with Counter Animations (890–1010)       */
/* ═══════════════════════════════════════════════════════════════ */
...
/*  Cinematic ₪0 drop with progressive tiers                      */
/* ═══════════════════════════════════════════════════════════════ */
      ...
      <SafeZone style={{ alignItems: "center", justifyContent: "center", gap: s(10) }}>
        ...
        <div
          style={{
            ...
            filter: `drop-shadow(0 0 ${s(50)}px ${COLORS.accent}35)`,
            opacity: priceDrop,
...
/*  Full branded close with everything                             */
/* ═══════════════════════════════════════════════════════════════ */
        ...
        >
          <Img
            ...
            style={{
              ...
              height: s(100),
              borderRadius: s(24),
              boxShadow: `0 ${s(10)}px ${s(40)}px rgba(0,0,0,0.5), 0 0 ${s(40)}px ${COLORS.accent}10`,
            }}
          />
          <h2
            style={{
...
/* ═══════════════════════════════════════════════════════════════ */
export const Launch_V6: React.FC = () => (
  <AbsoluteFill>
