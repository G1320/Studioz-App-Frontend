/**
 * Promo_Facebook_V6 — Full-length promo for Studioz Facebook page (DARK MODE)
    ...
    <AbsoluteFill style={{ ...RTL }}>
      ...
      <SafeZone style={{ alignItems: "center", justifyContent: "center", gap: s(24) }}>
        ...
        <GlassCard delay={18} style={{ width: "100%", display: "flex", justifyContent: "space-around", padding: `${s(32)}px ${s(16)}px` }}>
          ...
          <StatDisplay value="15h" label="חסכון/שבוע" delay={28} color={COLORS.accent} />
      ...
      <SafeZone style={{ alignItems: "center", justifyContent: "center", gap: s(12) }}>
        ...
        <div
          style={{
            ...
            filter: `drop-shadow(0 0 40px ${COLORS.accent}30)`,
            opacity: priceEnter,
...
/*  Main Export                                                    */
/* ═══════════════════════════════════════════════════════════════ */
export const Promo_Facebook_V6: React.FC = () => (
  <AbsoluteFill>
