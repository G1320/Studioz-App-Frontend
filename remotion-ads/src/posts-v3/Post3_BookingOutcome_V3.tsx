...
export const Post3_BookingOutcome_V3: React.FC = () => {
  const steps = [
    ...
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, flex: 1 }}>
          {steps.map((step, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              >
                <div style={{ fontFamily: "'DM Sans', 'Heebo', sans-serif", fontSize: 21, fontWeight: 700, color: LIGHT_TEXT, marginBottom: 2 }}>
                  {step.title}
                </div>
        ...
        >
          ...
          <span style={{ fontFamily: "'DM Sans', 'Heebo', sans-serif", fontSize: 22, fontWeight: 700, color: SUCCESS }}>
            +35%
          </span>
          <span style={{ fontFamily: "'DM Sans', 'Heebo', sans-serif", fontSize: 19, fontWeight: 600, color: SUCCESS }}>
