...
export const Post6_WhyWeBuilt_V3: React.FC = () => {
  const before = [
    ...
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <p style={{ fontFamily: "'IBM Plex Sans', 'Heebo', sans-serif", fontSize: 21, color: SUBTLE_TEXT, margin: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {before.map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <span style={{ fontFamily: "'IBM Plex Sans', 'Heebo', sans-serif", fontSize: 19, color: LIGHT_TEXT }}>
                    {item.text}
                  </span>
                </div>
              ))}
