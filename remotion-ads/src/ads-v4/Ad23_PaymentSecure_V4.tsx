...
const Scene1: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      <RadialGlow x="50%" y="25%" size={500} color={ACCENT_BLUE} opacity={0.08} />
      <div
        style={{
          display: "flex",
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK_BG, ...RTL }}>
      ...
      >
        ...
        >
          טופס הזמנה <GoldText>מאובטח</GoldText>
        </h2>
        <ScreenshotFrame
...
const Scene3: React.FC = () => (
  <CTAScene
    headline={
      <>
        תשלומים <GoldText>בטוחים ופשוטים</GoldText>
      </>
    }
  />
);
...
/* ─── Main Export ─── */
export const Ad23_PaymentSecure_V4: React.FC = () => (
  <AbsoluteFill>
