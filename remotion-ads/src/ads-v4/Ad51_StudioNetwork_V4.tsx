/**
 * Ad51_StudioNetwork_V4
 * Theme: Be part of the Studioz platform — NO fake counts of studios/users
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 10 }}>
          <FeatureCard
            ...
            desc="דף אולפן מקצועי ומותאם"
            delay={15}
          />
          <FeatureCard
            Icon={Search}
            title="חשיפה בגוגל"
            desc="SEO מובנה — Schema + Sitemap"
            delay={25}
          />
          <FeatureCard
            Icon={Users}
            title="לקוחות חדשים"
            desc="לקוחות שמחפשים אולפנים באזור"
            delay={35}
          />
          <FeatureCard
            Icon={Zap}
            title="הזמנות 24/7"
            desc="לקוחות מזמינים גם כשאתם ישנים"
            delay={45}
          />
        </div>
      </div>
...
/* ─── Main Export ─── */
export const Ad51_StudioNetwork_V4: React.FC = () => (
  <AbsoluteFill>
