...
export const EditItemForm = () => {
  ...
  // Service Delivery Type State - Initialize from item data
  const [serviceDeliveryType, setServiceDeliveryType] = useState<'in-studio' | 'remote'>(
  ...
  // Booking Settings State - Initialize from item data (for in-studio)
  ...
  // Remote Project Settings State - Initialize from item data (for remote)
  ...
  const steps: FormStep[] = useMemo(() => {
    ...
    const commonStartSteps: FormStep[] = [
      ...
      },
      {
        ...
        schema: itemStepSchemasEdit['service-type'],
        icon: HomeIcon,
