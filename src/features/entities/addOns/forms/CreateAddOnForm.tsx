    ...
    <section className="create-addon-form-container">
      ...
      {mode === 'local' && visibleAddOnsCount > 0 && (
        <div className="pending-addons-list">
          <h3>{t('form.addOn.pending')} ({visibleAddOnsCount})</h3>
          <div>
            {pendingAddOns.map((addOn, index) =>
              editingIndex === index ? null : (
                <div
                  key={addOn._id || index}
                  className={`pending-addon-card ${!addOn.isActive ? 'inactive' : ''}`}
                >
                  <div className="pending-addon-content">
                    <div className="pending-addon-name-row">
                      ...
                      {!addOn.isActive && (
                        <span className="pending-addon-badge">{t('form.addOn.inactive', { defaultValue: 'Inactive' })}</span>
                      )}
                    </div>
                    {addOn.description?.en && (
                      <div className="pending-addon-description">{addOn.description.en}</div>
                    )}
                  ...
                  <div className="pending-addon-actions">
                    {addOn.price !== undefined && (
                      <div className="pending-addon-price">₪{addOn.price}</div>
                    )}
                    {onRemove && (
                      <button
                        type="button"
          ...
          <div className="addon-form-fields">
            ...
            <div className="addon-form-field">
              ...
              <textarea
                ...
                placeholder={t('form.addOn.placeholders.descriptionEn', { defaultValue: "Describe what's included..." })}
              ...
              <div className="addon-form-field">
                ...
                <div className="addon-form-select-wrapper">
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, priceUnit: e.target.value as 'flat' | 'hourly' | 'daily' })}
