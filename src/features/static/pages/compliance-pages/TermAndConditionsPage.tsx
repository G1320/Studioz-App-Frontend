    ...
    <section className="terms-container">
      <div className="terms-content">
        <header className="terms-header">
          ...
          <p className="intro">Please read these terms and conditions carefully before using Our Service.</p>
        </header>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Studioz, Allenby 70, Tel aviv, Israel.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Feedback</strong> means feedback, innovations or suggestions sent by You regarding the attributes,
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Studioz, accessible from{' '}
              <a href="https://www.studioz.co.il" rel="external nofollow noopener" target="_blank">
        ...
        <p>
          Any Goods you purchase can only be returned in accordance with these Terms and Conditions and Our Returns
          Policy.
        </p>
        <p>
          Our Returns Policy forms a part of these Terms and Conditions. Please read our Returns Policy to learn more
          about your right to cancel Your Order.
        </p>
        <p>
          Your right to cancel an Order only applies to Goods that are returned in the same condition as You received
          them. You should also include all of the product's instructions, documents and wrappings. Goods that are
        ...
        <ul>
          ...
          <li>
            The supply of digital content which is not supplied on a tangible medium if the performance has begun with
        ...
        <p>
          We are constantly updating Our offerings of Goods on the Service. The Goods available on Our Service may be
        ...
        <h3>Payments</h3>
        <p>
          All Goods purchased are subject to a one-time payment. Payment can be made through various payment methods we
        ...
        <p>
          ...
          You are solely responsible for the Content and for all activity that occurs under Your account, whether done
        ...
        <p>
          ...
          any Content is appropriate and complies with these Terms, refuse or remove this Content. The Company further
        ...
        <p>
          ...
          must submit Your notice in writing to the attention of our copyright agent via email at admin@studioz.online
        ...
        <p>
          You can contact our copyright agent via email at admin@studioz.online. Upon receipt of a notification, the
        ...
        <ul>
          <li>By email: info@studioz.online</li>
        </ul>
      </div>
    </section>
  );
