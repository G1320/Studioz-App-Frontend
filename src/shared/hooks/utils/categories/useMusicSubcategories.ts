...
/**
 * Returns only subcategories that can be delivered remotely
 * (services that don't require physical presence at the studio)
 */
export const useRemoteMusicSubCategories = () => {
  const { t } = useTranslation('categories');
