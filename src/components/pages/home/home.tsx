...
export const Home: React.FC<HomeProps> = ({ studios, items }) => {
  ...
  return (
    <section className="home">
      ...
      <GenericCarousel data={studios} className="studios-carousel slider-gradient" renderItem={studioRenderItem} />
      ...
      <GenericCarousel data={items?.slice(0, 12)} className="items-carousel" renderItem={itemRenderItem} />
    </section>
  );
};
