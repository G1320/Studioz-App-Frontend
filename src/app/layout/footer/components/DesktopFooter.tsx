        ...
        <div className="desktop-footer__grid">
          ...
          <div className="desktop-footer__brand">
            <div className="desktop-footer__logo">
              <img src="/favicon-32x32.png" alt="Studioz Logo" width={32} height={32} loading="lazy" decoding="async" />
              <span>Studioz</span>
            </div>
          ...
          <div className="desktop-footer__links">
            ...
            <ul>
              ...
              <li>
                <a
                  href={`${langPrefix}/accessibility-statement`}
                  onClick={(e) => handleClick(e, '/accessibility-statement')}
                >
